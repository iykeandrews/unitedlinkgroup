...
import { ChevronLeft, Save, Building, MapPin, Navigation } from 'lucide-react';
...
function NewSiteForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.response?.data?.message || 'Failed to create site. Please try again.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none disabled:opacity-60"
            >
            ...
            {preSelectedClientId && (
                <p className="mt-1 text-xs text-slate-500">Linked to: {preSelectedClientName || 'Selected Client'}</p>
            )}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input
                ...
                placeholder="e.g. Main HQ Entrance"
              />
            </div>
