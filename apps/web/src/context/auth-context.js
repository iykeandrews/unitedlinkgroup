...
function AuthProvider({ children }) {
    ...
    const refreshProfile = async () => {
        ...
        try {
            ...
            const employeeType = response === null || response === void 0 ? void 0 : response.data.employeeType;
            if (employeeType)
    ...
    return (<AuthContext.Provider value={{ user, loading, refreshProfile, logout }}>
      {children}
