...
export default function AssetAssignmentModal({ isOpen, onClose, onSuccess, asset }: AssetAssignmentModalProps) {
        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea
              ...
              placeholder="Condition notes, specific instructions, etc."
            />
          </div>
        </div>
        ...
        <div className="flex justify-between pt-4 border-t border-slate-200 dark:border-slate-700">
          {asset.assignedToId ? (
            <button
              ...
              disabled={loading}
              className="px-4 py-2 text-sm font-medium text-red-600 bg-red-50 hover:bg-red-100 rounded-lg dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30 transition-colors"
            >
              Unassign Asset
            </button>
          ) : (
