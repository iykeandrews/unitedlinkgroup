...
export default function DesignProjectList({ projects, viewMode, onSelectProject }: DesignProjectListProps) {
                    ...
                    {project.stages.slice(0, 3).map((stage, i) => (
                        <div 
                            ...
                            className={`w-2 h-2 rounded-full ${
                                ...
                                stage.status === 'In Progress' ? 'bg-amber-500' : 'bg-slate-200 dark:bg-slate-600'
                            }`} 
                            title={stage.name}
                        />
                    ))}
