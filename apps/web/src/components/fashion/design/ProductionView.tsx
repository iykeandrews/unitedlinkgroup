...
import { ProductionRun } from '../../../types/fashion';
import { Factory, Calendar, AlertTriangle, CheckCircle2 } from 'lucide-react';

export default function ProductionView({ production }: { production?: ProductionRun }) {
  if (!production) {
    return (
      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
        ...
        <div className="space-y-6">
            {production.stages.map((stage, index) => (
                <div key={index} className="relative pl-8 pb-6 last:pb-0 border-l-2 border-slate-200 dark:border-slate-700 last:border-0">
