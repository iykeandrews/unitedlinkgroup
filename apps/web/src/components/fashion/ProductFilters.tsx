...
export function ProductFilters({ className, onClose, filters, onFilterChange }: ProductFiltersProps) {
  ...
  return (
    <div className={`bg-white dark:bg-slate-800 h-full overflow-y-auto ${className}`}>
      ...
      <div className="p-4 lg:p-0">
        ...
        <FilterSection title="Product Type">
          <div className="space-y-2">
            {['Shirts', 'Dresses', 'Jeans', 'Shoes', 'Accessories'].map((type) => (
        ...
        <FilterSection title="Size">
          <div className="grid grid-cols-4 gap-2">
            {['XS', 'S', 'M', 'L', 'XL', 'XXL', '38', '40', '42'].map((size) => (
              <button 
                key={size}
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <button
                ...
                className={`w-6 h-6 rounded-full border transition-transform ring-offset-1 focus:ring-2 ring-indigo-500 ${
        ...
        <FilterSection title="Brand">
          <div className="space-y-2">
            {['Nike', 'Adidas', 'Zara', 'H&M', 'Gucci', 'Uniqlo', 'United Fashion', 'Bloom & Co', 'Street King', 'Heritage', 'Denim Co'].map((brand) => (
