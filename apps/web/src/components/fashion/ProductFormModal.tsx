...
import { X, Trash2, Upload, RefreshCw } from 'lucide-react';
import { motion } from 'framer-motion';
import { Product, ProductStatus, Gender, ProductVariant, ProductImage } from '../../types/fashion';
...
export function ProductFormModal({ isOpen, onClose, product, onSave }: ProductFormModalProps) {
  const [activeTab, setActiveTab] = useState<'general' | 'details' | 'media' | 'variants'>('general');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-4xl bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
      >
        {/* Header */}
        ...
        <div className="flex border-b border-slate-200 dark:border-slate-700 px-6">
          {['general', 'details', 'media', 'variants'].map((tab) => (
            <button
              key={tab}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="number" 
                      className="w-full pl-8 pr-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-indigo-500"
                      placeholder="0.00"
                ...
                <div className="col-span-2">
                  ...
                  <textarea 
                    className="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-2 focus:ring-indigo-500 h-32 resize-none"
          ...
          {activeTab === 'media' && (
            <div className="space-y-6">
              <div 
                ...
                className="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl p-8 text-center hover:border-indigo-500 transition-colors cursor-pointer"
              >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {formData.images?.map((img, i) => (
                  <div key={i} className="relative aspect-square bg-slate-100 dark:bg-slate-700 rounded-lg overflow-hidden group">
          ...
          {activeTab === 'variants' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <button 
                  onClick={() => setShowVariantGen(!showVariantGen)}
              ...
              {showVariantGen && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-indigo-600 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                <table className="w-full text-sm text-left">
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                    {formData.variants?.map((variant) => (
                      <tr key={variant.id} className="bg-white dark:bg-slate-800">
