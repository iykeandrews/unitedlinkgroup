...
let DepartmentsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('departments'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    (() => {
        ...
        _assignManager_decorators = [(0, common_1.Post)(':id/manager'), (0, roles_decorator_1.Roles)(types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.SUPER_ADMIN)];
        _removeManager_decorators = [(0, common_1.Delete)(':id/manager'), (0, roles_decorator_1.Roles)(types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.SUPER_ADMIN)];
        ...
        __esDecorate(_classThis, null, _assignManager_decorators, { kind: "method", name: "assignManager", static: false, private: false, access: { has: obj => "assignManager" in obj, get: obj => obj.assignManager }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _removeManager_decorators, { kind: "method", name: "removeManager", static: false, private: false, access: { has: obj => "removeManager" in obj, get: obj => obj.removeManager }, metadata: _metadata }, null, _instanceExtraInitializers);
