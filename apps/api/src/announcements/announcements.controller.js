...
let AnnouncementsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('announcements'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var AnnouncementsController = _classThis = class {
        constructor(announcementsService) {
            this.announcementsService = (__runInitializers(this, _instanceExtraInitializers), announcementsService);
        }
        create(req, businessIdHeader, createAnnouncementDto) {
            var _a;
            return this.announcementsService.create(createAnnouncementDto, req.user.userId, (_a = req.user.businessId) !== null && _a !== void 0 ? _a : businessIdHeader);
        }
        findAll(req, businessIdHeader) {
            const user = req.user;
            const resolve = (bid) => this.announcementsService.findAll(user.userId, bid);
        ...
        update(req, businessIdHeader, id, updateAnnouncementDto) {
            var _a;
            return this.announcementsService.update(id, updateAnnouncementDto, req.user.userId, (_a = req.user.businessId) !== null && _a !== void 0 ? _a : businessIdHeader);
        }
        markAsRead(req, id) {
            return this.announcementsService.markAsRead(id, req.user.userId);
        }
        remove(req, businessIdHeader, id) {
            var _a;
            return this.announcementsService.remove(id, req.user.userId, (_a = req.user.businessId) !== null && _a !== void 0 ? _a : businessIdHeader);
        }
    };
    __setFunctionName(_classThis, "AnnouncementsController");
    (() => {
        ...
        AnnouncementsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AnnouncementsController = _classThis;
})();
