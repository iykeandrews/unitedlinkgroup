...
exports.CompanyCertificationsController = void 0;
const common_1 = require("@nestjs/common");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
const roles_guard_1 = require("../auth/roles.guard");
const roles_decorator_1 = require("../auth/roles.decorator");
const types_1 = require("@unitedlinkgroup/types");
let CompanyCertificationsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('company-certifications'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true, forbidNonWhitelisted: true, transform: true }))];
    ...
    var CompanyCertificationsController = _classThis = class {
        constructor(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        list(req, headerBusinessId, queryBusinessId) {
            return this.service.list(req.user, headerBusinessId, queryBusinessId);
        }
        create(req, headerBusinessId, queryBusinessId, dto) {
            return this.service.create(req.user, headerBusinessId, dto, queryBusinessId);
        }
        update(req, headerBusinessId, queryBusinessId, id, dto) {
            return this.service.update(req.user, headerBusinessId, id, dto, queryBusinessId);
        }
        delete(req, headerBusinessId, queryBusinessId, id) {
            return this.service.delete(req.user, headerBusinessId, id, queryBusinessId);
        }
    };
    __setFunctionName(_classThis, "CompanyCertificationsController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _list_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)(types_1.UserRole.SUPER_ADMIN, types_1.UserRole.BUSINESS_ADMIN)];
        ...
        CompanyCertificationsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CompanyCertificationsController = _classThis;
})();
exports.CompanyCertificationsController = CompanyCertificationsController;
