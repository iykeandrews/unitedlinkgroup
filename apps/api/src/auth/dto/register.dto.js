...
let RegisterDto = (() => {
    ...
    return _a = class RegisterDto {
            constructor() {
                ...
                this.role = (__runInitializers(this, _businessName_extraInitializers), __runInitializers(this, _role_initializers, void 0));
        ...
        (() => {
            ...
            _businessName_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _role_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(types_1.UserRole)];
