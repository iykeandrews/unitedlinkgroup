...
let AppController = (() => {
    ...
    (() => {
        ...
        _getBusinesses_decorators = [(0, common_1.Get)('businesses')];
        ...
        __esDecorate(_classThis, null, _getBusinesses_decorators, { kind: "method", name: "getBusinesses", static: false, private: false, access: { has: obj => "getBusinesses" in obj, get: obj => obj.getBusinesses }, metadata: _metadata }, null, _instanceExtraInitializers);
