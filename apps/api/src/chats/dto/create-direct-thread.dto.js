...
exports.CreateDirectThreadDto = void 0;
const class_validator_1 = require("class-validator");
let CreateDirectThreadDto = (() => {
    var _a;
    let _employeeId_decorators;
    let _employeeId_initializers = [];
    let _employeeId_extraInitializers = [];
    return _a = class CreateDirectThreadDto {
            constructor() {
                this.employeeId = __runInitializers(this, _employeeId_initializers, void 0);
                __runInitializers(this, _employeeId_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _employeeId_decorators = [(0, class_validator_1.IsUUID)()];
...
exports.CreateDirectThreadDto = CreateDirectThreadDto;
