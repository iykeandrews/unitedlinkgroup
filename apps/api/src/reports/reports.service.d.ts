...
export declare class ReportsService {
    ...
    getBusinessOverview(businessId: string, days?: number): Promise<{
        now: Date;
        rangeDays: number;
        kpis: {
    ...
    getPayrollSummary(userId: string, startDate?: string, endDate?: string): Promise<{
        period: {
    ...
    getLaborCostAnalysis(businessId: string, startDate?: string, endDate?: string): Promise<{
        totalHours: number;
        estimatedCost: number;
        timesheetCount: number;
    }>;
    getAttendanceReport(businessId: string, startDate?: string, endDate?: string): Promise<({
        employee: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    getReliabilityReport(businessId: string, startDate?: string, endDate?: string): Promise<{
        range: {
            start: string;
            end: string;
        };
    ...
    getSuperadminDashboard(days?: number): Promise<{
        now: Date;
        rangeDays: number;
        totals: {
    ...
    getEmployeeDashboard(userId: string, days?: number, businessId?: string): Promise<{
        now: Date;
        employee: {
            id: string;
            firstName: string;
