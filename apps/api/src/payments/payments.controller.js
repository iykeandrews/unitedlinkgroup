...
let PaymentsController = (() => {
    ...
    var PaymentsController = _classThis = class {
        ...
        create(req, createPaymentDto, headerBusinessId) {
        ...
        findOne(id, req, headerBusinessId) {
    ...
    (() => {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, roles_decorator_1.Roles)(types_1.UserRole.SUPER_ADMIN, types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.MANAGER), (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true, transform: true }))];
