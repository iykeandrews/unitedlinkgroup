...
let CreateAssignmentDto = (() => {
    ...
    return _a = class CreateAssignmentDto {
            constructor() {
                this.businessId = __runInitializers(this, _businessId_initializers, void 0);
                this.title = (__runInitializers(this, _businessId_extraInitializers), __runInitializers(this, _title_initializers, void 0));
