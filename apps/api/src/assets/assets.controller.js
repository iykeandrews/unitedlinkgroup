...
let AssetsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('assets'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    __setFunctionName(_classThis, "AssetsController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _create_decorators = [(0, common_1.Post)(), (0, roles_decorator_1.Roles)(types_1.UserRole.SUPER_ADMIN, types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.MANAGER), (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true }))];
        _assign_decorators = [(0, common_1.Post)(':id/assign'), (0, roles_decorator_1.Roles)(types_1.UserRole.SUPER_ADMIN, types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.MANAGER), (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true }))];
        _returnAsset_decorators = [(0, common_1.Post)(':id/return'), (0, roles_decorator_1.Roles)(types_1.UserRole.SUPER_ADMIN, types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.MANAGER)];
        _getHistory_decorators = [(0, common_1.Get)(':id/history'), (0, roles_decorator_1.Roles)(types_1.UserRole.SUPER_ADMIN, types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.MANAGER)];
        ...
        __esDecorate(_classThis, null, _returnAsset_decorators, { kind: "method", name: "returnAsset", static: false, private: false, access: { has: obj => "returnAsset" in obj, get: obj => obj.returnAsset }, metadata: _metadata }, null, _instanceExtraInitializers);
