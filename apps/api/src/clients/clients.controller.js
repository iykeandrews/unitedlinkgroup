...
let ClientsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('clients'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var ClientsController = _classThis = class {
        ...
        create(req, createClientDto, businessId) {
