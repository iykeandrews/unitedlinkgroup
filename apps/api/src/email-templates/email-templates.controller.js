...
let EmailTemplatesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('email-templates'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var EmailTemplatesController = _classThis = class {
        constructor(emailTemplatesService) {
            this.emailTemplatesService = (__runInitializers(this, _instanceExtraInitializers), emailTemplatesService);
        }
        create(req, createEmailTemplateDto) {
        ...
        update(req, id, updateEmailTemplateDto) {
    ...
    __setFunctionName(_classThis, "EmailTemplatesController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _create_decorators = [(0, common_1.Post)(), (0, roles_decorator_1.Roles)(types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.SUPER_ADMIN, types_1.UserRole.MANAGER)];
        ...
        _remove_decorators = [(0, common_1.Delete)(':id'), (0, roles_decorator_1.Roles)(types_1.UserRole.BUSINESS_ADMIN, types_1.UserRole.SUPER_ADMIN, types_1.UserRole.MANAGER)];
        ...
        EmailTemplatesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EmailTemplatesController = _classThis;
})();
